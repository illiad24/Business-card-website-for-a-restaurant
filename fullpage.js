import { isMobile } from "../files/utils.js";
...
export class FullPage {
    constructor(element, options) {
        let config = {
            ...
            scrollSelector: '[data-scroll-section]',
            scrollValue: false,
            //===============================
    ...
    touchMove(e) {
        ...
        // console.log(this.options.scrollValue)
        if (!this.clickOrTouch || this.options.scrollValue || e.target.closest(this.options.scrollSelector)) return
    ...
    wheel(e) {
        ...
        // console.log('wheel')
        // console.log(this.options.scrollValue)
        if (this.options.scrollValue || e.target.closest(this.options.scrollSelector)) return
